...
# 791 "C:\\Program Files\\Microchip\\xc8\\v2.40\\pic\\sources\\c99\\common\\doprnt.c"
 ...
 union {
  ...
  switch(c) {
   ...
   case 'h':
    ...
    break;
# 1149 "C:\\Program Files\\Microchip\\xc8\\v2.40\\pic\\sources\\c99\\common\\doprnt.c"
   case 't':
  ...
  if (*cp == 'd' || *cp == 'i') {
   ...
   switch (c) {
    ...
    case 'h':
     convarg.ll = (long long)(short)(*(int *)__va_arg(*(int **)ap, (int)0));
     break;


    case 'H':
     convarg.ll = (long long)(signed char)(*(int *)__va_arg(*(int **)ap, (int)0));
     break;
# 1214 "C:\\Program Files\\Microchip\\xc8\\v2.40\\pic\\sources\\c99\\common\\doprnt.c"
    case 't':
     convarg.ll = (long long)(*(ptrdiff_t *)__va_arg(*(ptrdiff_t **)ap, (ptrdiff_t)0));
     break;
    ...
    case 'z':
     convarg.ll = (long long)(*(size_t *)__va_arg(*(size_t **)ap, (size_t)0));
     break;
  ...
  if (0
   ...
   switch (c) {
    ...
    case 'H':
     convarg.llu = (unsigned long long)(unsigned char)(*(unsigned int *)__va_arg(*(unsigned int **)ap, (unsigned int)0));
     break;
# 1279 "C:\\Program Files\\Microchip\\xc8\\v2.40\\pic\\sources\\c99\\common\\doprnt.c"
    case 't':
     convarg.llu = (unsigned long long)(*(ptrdiff_t *)__va_arg(*(ptrdiff_t **)ap, (ptrdiff_t)0));
     break;
    ...
    case 'z':
     convarg.llu = (unsigned long long)(*(size_t *)__va_arg(*(size_t **)ap, (size_t)0));
     break;
   ...
   *fmt = cp+1;
   switch (*cp) {
    ...
    case 'o':
     return (int) otoa(fp, convarg.llu);


    case 'u':
     return (int) utoa(fp, convarg.llu);
    ...
    case 'x':
     ...
     return (int) xtoa(fp,convarg.llu,*cp);
  ...
  if (*cp == 'n') {
   ...
   switch (c) {
     ...
     *(*(signed char* *)__va_arg(*(signed char* **)ap, (signed char*)0)) = (signed char) nout;
     break;
# 1349 "C:\\Program Files\\Microchip\\xc8\\v2.40\\pic\\sources\\c99\\common\\doprnt.c"
    case 't':
   ...
   *fmt = cp+1;
   return (int) 0;
        ...
        if (*fmt[0] == 'p') {
            ++*fmt;
            return (int) xtoa(fp,(unsigned long long)(uintptr_t)(*(void * *)__va_arg(*(void * **)ap, (void *)0)),'x');
        }
