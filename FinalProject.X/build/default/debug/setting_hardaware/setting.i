...
# 53 "C:\Program Files\Microchip\xc8\v2.40\pic\include\proc\pic18f4520.h"
...
# 6 "setting_hardaware/ccp1.h"
void CCP1_Initialize();

# 34 "setting_hardaware/adc.h"
void ADC_Initialize() ;
int ADC_Read(int maxtime);

# 3 "setting_hardaware/interrupt_manager.h"
...
# 61 "setting_hardaware/setting.c"
void SYSTEM_Initialize(void)
{
